/**
 * SEO Local — datos del negocio físico de Mundo Tech.
 * Persistidos en AppConfig.key='seo_local'. Editables desde
 * /admin/settings/seo-local sin tocar código.
 */
import { z } from 'zod';
...
/** Etiqueta humana para mostrar horarios en la UI pública. */
