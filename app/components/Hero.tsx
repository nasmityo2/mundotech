...
const FALLBACK_SLIDES: Slide[] = [
  {
    ...
    badge:   'MundoTech',
    title:   '',
    sub:     'Desde Barquisimeto para toda Venezuela. Gadgets, audio, consolas y tecnología práctica.',
    cta:     'Ver catálogo',
    href:    '/productos',
  ...
  {
    variant: 'standard',
    badge:   'Apple & portátiles',
    title:   'MacBook y\necosistema Apple',
    sub:     'Portátiles y accesorios con stock verificado y envío seguro.',
    cta:     'Ver laptops',
    href:    '/productos?cat=Laptops',
    img:     US('photo-1698664698797-bd3c93ff2b64'),
    tag:     'Destacado',
  },
];
