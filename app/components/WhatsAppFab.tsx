 ...
 * Oculto en admin y en el checkout (allí compite con el CTA de pago).
 */
      ...
      {visible && (
        ...
        >
          <span className="flex h-[52px] w-[52px] items-center justify-center sm:h-14 sm:w-14">
            {/* Glyph oficial de WhatsApp */}
            <svg viewBox="0 0 32 32" fill="currentColor" className="h-7 w-7 sm:h-[30px] sm:w-[30px]" aria-hidden>
